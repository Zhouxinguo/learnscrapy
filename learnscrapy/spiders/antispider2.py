...
from learnscrapy.items import Antispider2Item


class AntiSpider2(scrapy.Spider):
    name = 'antispider2'

    def start_requests(self):
        urls = [f'https://antispider2.scrape.center/page/{a}' for a in range(1,11)]
        for url in urls:
